...
namespace csharp.helper.Tasks
{
    ...
    /// ------------------------------------------------------------------------------------------------
    /// <summary>
    /// Author: http://stackoverflow.com/users/222434/jim Link: http://stackoverflow.com/a/14945407
    /// Factory class to create a periodic Task to simulate a <see cref="System.Threading.Timer"/>
    /// using <see cref="Task">Tasks.</see>
    /// </summary>
    /// ------------------------------------------------------------------------------------------------
    public static class PeriodicTaskFactory
    {
        ...
        /// <param name="delayInMilliseconds">        The delay in milliseconds, i.e. how long it waits to
        /// kick off the timer.</param>
        /// <param name="duration">                   The duration.</param>
        /// <param name="maxIterations">              The max iterations.</param>
        /// <param name="synchronous">                if set to <c>true</c> executes each period in a
        /// blocking fashion and each periodic execution of the task is included in the total duration of
        /// the Task.</param>
        /// <param name="cancelToken">                The cancel token.</param>
        /// <param name="periodicTaskCreationOptions"><see cref="TaskCreationOptions"/> used to create the
        /// task for executing the <see cref="Action"/>.</param>
        ...
        /// <param name="periodicTaskCreationOptions"><see cref="TaskCreationOptions"/> used to create a
        /// sub task for executing the <see cref="Action"/>.</param>
        /// ------------------------------------------------------------------------------------------------
                                                   ...
                                                   TaskCreationOptions periodicTaskCreationOptions)
        {
            ...
            using (var periodResetEvent = new ManualResetEventSlim(false))
            {
                ...
                while (true)
                {
                    ...
                    // use the same Timeout setting as the System.Threading.Timer, infinite timeout
                    // will execute only one iteration.
                    ...
                    {
                        Console.WriteLine("Periodic task has been cancelled");
                        break;
                    }
                    finally
                    {
